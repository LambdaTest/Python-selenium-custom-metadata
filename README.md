# Add Custom Metadata to Python Selenium Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can add Custom Metadata to Python Selenium Tests across real browsers and operating systems.
...
# Steps
With TestMu AI (Formerly LambdaTest), you can add custom meta data to automation tests. These are added for tests by setting the data in `customData` capability. The code below illustrates the usage:
